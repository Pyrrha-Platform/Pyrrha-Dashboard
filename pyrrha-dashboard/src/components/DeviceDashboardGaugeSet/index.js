...
const DeviceDashboardGaugeSet = memo(
  function DeviceDashboardGaugeSet({
    ...
    console.log(
      `DeviceDashboardGaugeSet - Rendering device ${device_id} (${device_name}) with CO: ${carbon_monoxide}`,
    );
    console.log(
      `DeviceDashboardGaugeSet - Full props for device ${device_id}:`,
      {
        device_id,
        device_name,
        timestamp_mins,
  ...
  (prevProps, nextProps) => {
    ...
    return (
      ...
      prevProps.device_name === nextProps.device_name &&
      prevProps.device_timestamp === nextProps.device_timestamp &&
      prevProps.temperature === nextProps.temperature &&
      prevProps.humidity === nextProps.humidity &&
      prevProps.carbon_monoxide === nextProps.carbon_monoxide &&
      prevProps.nitrogen_dioxide === nextProps.nitrogen_dioxide &&
      prevProps.increment === nextProps.increment
    );
  },
);
