...
class Constants {
  ...
  static CO_YELLOW = 420; // Not official
  static NO2_YELLOW = 8;
  ...
  static CO_10_MN_RED = 0; // Not official
  static NO2_10_MN_RED = 0; // Not official

  static CO_30_MN_YELLOW = 150;
  static NO2_30_MN_YELLOW = 6;
  static CO_30_MN_RED = 0; // Not official
  static NO2_30_MN_RED = 0; // Not official

  static CO_1_HR_YELLOW = 83;
  static NO2_1_HR_YELLOW = 4;
  static CO_1_HR_RED = 0; // Not official
  static NO2_1_HR_RED = 0; // Not official

  static CO_4_HR_YELLOW = 33;
  static NO2_4_HR_YELLOW = 2;
  static CO_4_HR_RED = 0; // Not official
  static NO2_4_HR_RED = 0; // Not official

  static CO_8_HR_YELLOW = 27;
  static NO2_8_HR_YELLOW = 1;
  static CO_8_HR_RED = 0; // Not official
  static NO2_8_HR_RED = 0; // Not official
}
