      ...
      <ModalStateManager
        ...
        {({ open, setOpen }) => (
          <ComposedModal
            ...
            <ModalBody />
            <ModalFooter {...deleteProps.modalFooter()} shouldCloseAfterSubmit={true} onRequestSubmit={() => { handleSubmit(this.state.id, this.state.code, this.state.first, this.state.last, this.state.email, this.state.loadFirefighters, setOpen); }} />
          </ComposedModal>
        )}
      </ModalStateManager>
    );
