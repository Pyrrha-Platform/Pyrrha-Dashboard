    ...
    <div className="bx--grid bx--grid--full-width details-content">
      ...
      <div class="bx--row">
        <div class="bx--col-lg-8 bx--col-md-4 bx--col-sm-2">
          <div className="bx--grid bx--grid--full-width details-content">
            <div className="bx--row details-tile">
              <div className="bx--col-md-8 label-firefighter">Now</div>
            </div>
            <div className="bx--row details-tile">
        ...
        <div class="bx--col-lg-8 bx--col-md-4 bx--col-sm-2">
          <div className="bx--grid bx--grid--full-width details-content">
            <div className="bx--row details-tile">
              <div className="bx--col-md-8 label-firefighter">10 min avg</div>
            </div>
            <div className="bx--row details-tile">
              <div className="bx--col bx--col-md-2">
                <div>
      ...
      <div class="bx--row">
        <div class="bx--col-lg-8 bx--col-md-4 bx--col-sm-2">
          <div className="bx--grid bx--grid--full-width details-content">
            <div className="bx--row details-tile">
              <div className="bx--col-md-8 label-firefighter">30 min avg</div>
            </div>
            <div className="bx--row details-tile">
              <div className="bx--col bx--col-md-2">
                <div>
        ...
        <div class="bx--col-lg-8 bx--col-md-4 bx--col-sm-2">
          <div className="bx--grid bx--grid--full-width details-content">
            <div className="bx--row details-tile">
              <div className="bx--col-md-8 label-firefighter">1 hr avg</div>
            </div>
            <div className="bx--row details-tile">
              <div className="bx--col bx--col-md-2">
                <div>
      ...
      <div class="bx--row">
        <div class="bx--col-lg-8 bx--col-md-4 bx--col-sm-2">
          <div className="bx--grid bx--grid--full-width details-content">
            <div className="bx--row details-tile">
              <div className="bx--col-md-8 label-firefighter">4 hr avg</div>
            </div>
            <div className="bx--row details-tile">
              <div className="bx--col bx--col-md-2">
                <div>
        ...
        <div class="bx--col-lg-8 bx--col-md-4 bx--col-sm-2">
          <div className="bx--grid bx--grid--full-width details-content">
            <div className="bx--row details-tile">
              <div className="bx--col-md-8 label-firefighter">8 hr avg</div>
            </div>
            <div className="bx--row details-tile">
              <div className="bx--col bx--col-md-2">
                <div>
